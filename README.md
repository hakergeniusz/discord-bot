...
> **Note:** When downloading by this exact command, you download from `main` branch. Main branch may have unfinished changes. It is recommended to use releases instead.
